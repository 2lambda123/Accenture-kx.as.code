...
downloadFile "https://github.com/kubernetes-sigs/krew/releases/download/${krewVersion}/krew-linux_${cpuArchitecture}.tar.gz" \
  "${!krewChecksum}" \
  "${installationWorkspace}/krew-linux_${cpuArchitecture}.tar.gz"

# Unpack downloaded file
tar xvzf ${installationWorkspace}/krew-linux_${cpuArchitecture}.tar.gz --directory ${installationWorkspace}
