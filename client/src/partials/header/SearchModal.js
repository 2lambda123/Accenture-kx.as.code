...
function SearchModal() {
  ...
  return (
    <div>
      ...
      <button
        ref={trigger}
        className={`w-8 h-8 flex items-center justify-center bg-white hover:bg-gray-200 transition duration-150 rounded-full ml-3 ${searchOpen && 'bg-gray-200'}`}
        onClick={() => { setSearchOpen(!searchOpen); setImmediate(() => searchInput.current.focus()); }}
        aria-controls="search-modal"
      >
        <span className="sr-only">Search</span>
        <svg className="w-4 h-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path className="fill-current text-ghBlack" d="M7 14c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zM7 2C4.243 2 2 4.243 2 7s2.243 5 5 5 5-2.243 5-5-2.243-5-5-5z" />
          <path className="fill-current text-ghBlack" d="M15.707 14.293L13.314 11.9a8.019 8.019 0 01-1.414 1.414l2.393 2.393a.997.997 0 001.414 0 .999.999 0 000-1.414z" />
        </svg>
      </button>
      {/* Modal backdrop */}
      <Transition
              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span>Lorem Ipsum - Dolor sid amet</span>
                  </Link>
                </li>
                <li>
                  <Link
              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-800 group-hover:text-white">Applications</span> - Applications / … / Lorem</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span><span className="font-medium text-gray-800 group-hover:text-white">Settings</span> - Settings / … / Ipsum</span>
                  </Link>
                </li>
              </ul>
            </div>
